...
//DECK BUILDER
const int DECKBUILDER_ROWS = 4;
const int DECKBUILDER_COLS = 6;
const float CONST_DECKBUILDER_COLLECTION_X = 7.5f;
const float CONST_DECKBUILDER_COLLECTION_Y = 15.f;
const float CONST_DECKBUILDER_COLLECTION_Z = 4.f;
const float CONST_DECKBUILDER_COLLECTION_SEPERATION_X = 2.1f;
const float CONST_DECKBUILDER_COLLECTION_SEPERATION_Z = 3.f;

const float CONST_DECKBUILDER_DECK_X = -6.f;
const float CONST_DECKBUILDER_DECK_Y = 15.f;
const float CONST_DECKBUILDER_DECK_Z = -3.f;
