...
public:
	...
	*/
	...
	void setMaxUniforms(int uniforms);
	...
	*/
	...
	void setUniformInt(int id, int val);
	void setUniformMat4f(int id, glm::mat4 matrix);
	void setUniformVec3f(int id, glm::vec3 vec);
	void setUniformVec4f(int id, glm::vec4 vec);
